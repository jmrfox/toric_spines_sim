"""TS2 axon-input Dash dashboard (3D animation + traces + raster).

Run from the repository root::

    uv run python -m simulations.ts2.axons_dash
"""
...
from simulations.ts2.inputs import (
    MODEL,
    axon_periodic_input,
    axon_poisson_input,
...
# Input scenario: set the function (see simulations/ts2/inputs.py).
