"""TS4 axon-input Dash dashboard (3D animation + traces + raster).

Run from the repository root::

    uv run python -m simulations.ts4.axons_dash
"""
...
from simulations.ts4.inputs import (
    MODEL,
    axon_periodic_input,
    axon_poisson_input,
...
# Input scenario: set the function (see simulations/ts4/inputs.py).
