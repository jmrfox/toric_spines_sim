"""TS67 axon-input Dash dashboard (3D animation + traces + raster).

Run from the repository root::

    uv run python -m simulations.ts67.axons_dash
"""
...
from simulations.ts67.inputs import (
    MODEL,
    axon_periodic_input,
    axon_poisson_input,
...
# Input scenario: set the function (see simulations/ts67/inputs.py).
