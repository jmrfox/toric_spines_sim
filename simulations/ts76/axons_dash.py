"""TS76 axon-input Dash dashboard (3D animation + traces + raster).
...
from simulations.ts76.inputs import (
    MODEL,
    axon_periodic_input,
    axon_poisson_input,
...
# Input scenario: set the function (see simulations/ts76/inputs.py).
