...
swc_spine_px_filepath = Path("../data/swc/pixels/TS2_s50_equivalent_area.swc")
neckpt_px_filepath = Path("../data/pointsets/pixels/TS2_neckpoint.txt")
swc_with_sink_px_filepath = Path(
    f"../data/swc/pixels/TS2_s50_wsink_r{sink_radius_um}um.swc"
)
swc_with_sink_um_filepath = Path(
    f"../data/swc/microns/TS2_s50_wsink_r{sink_radius_um}um.swc"
)
az_px_filepath = Path("../data/pointsets/pixels/TS2_AZ.txt")
synpts_um_filepath = Path("../data/pointsets/microns/TS2_synpts.txt")
...
plot_model(swc_model=swc_spine_model_px, point_set=neckpt_pointset_px, point_size=3)
...
out_path = append_sink_to_swc(
    ...
    neck_point=neckpt_px_filepath,  # or (x,y,z)
    geom=geom,
    tag=5,
)
